    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#story" className="text-xs font-mono uppercase text-zinc-400 hover:text-white transition-colors">Story</a>
          ...
          <a href="#capabilities" className="text-xs font-mono uppercase text-zinc-400 hover:text-white transition-colors">Stack</a>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-white/5 bg-black/95 backdrop-blur-md">
          <div className="px-6 py-4 space-y-4">
            ...
            <a href="#story" onClick={() => setMobileMenuOpen(false)} className="block text-xs font-mono uppercase text-zinc-400 hover:text-white transition-colors">Story</a>
            ...
            <a href="#capabilities" onClick={() => setMobileMenuOpen(false)} className="block text-xs font-mono uppercase text-zinc-400 hover:text-white transition-colors">Stack</a>
            <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-2 border border-white/20 text-xs font-mono uppercase text-center hover:bg-white hover:text-black transition-all">Connect</a>
          </div>
        </div>
      )}
    </nav>
