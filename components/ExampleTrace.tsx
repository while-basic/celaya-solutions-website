      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-10 items-start">
          <div>
            ...
            <p className="font-body text-cs-gray-500 text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={m.label} className="border border-cs-gray-700 rounded bg-cs-gray-900 p-5">
                ...
                <p className="font-mono text-[0.6rem] text-cs-gray-500 uppercase tracking-[0.15em] mb-0.5">{m.label}</p>
                <p className="font-mono text-[0.6rem] text-cs-gray-600 uppercase tracking-[0.1em]">{m.sub}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="border border-cs-gray-700 rounded overflow-hidden">
          ...
          <div className="flex items-center gap-2 px-4 py-3 border-b border-cs-gray-700 bg-cs-gray-900">
            ...
            <span className="font-mono text-[0.7rem] text-cs-gray-500 ml-3 uppercase tracking-[0.15em]">
          ...
          <div className="bg-cs-black p-6 md:p-8 font-mono text-[0.75rem] leading-relaxed overflow-x-auto">
            <div className="space-y-5 text-cs-gray-400">
              ...
              {/* Header */}
              <div>
                <div className="text-cs-gray-600 mb-2">{'// ─────────────────────────────────────────────────────────────────────'}</div>
                <div><span className="text-cs-gray-500">TRACE RECEIPT</span></div>
                <div className="text-cs-gray-600">{'// ─────────────────────────────────────────────────────────────────────'}</div>
              </div>

              {/* Metadata */}
              <div className="space-y-1">
                <div className="grid grid-cols-[140px_1fr] gap-2">
                  <span className="text-cs-gray-600">Instrument:</span>
                  <span className="text-cs-orange">CLOS v1.4.2</span>
                </div>
                <div className="grid grid-cols-[140px_1fr] gap-2">
                  <span className="text-cs-gray-600">Run ID:</span>
                  <span className="text-white">CLOS-2024-0891</span>
                </div>
                <div className="grid grid-cols-[140px_1fr] gap-2">
                  <span className="text-cs-gray-600">Timestamp:</span>
                  <span className="text-cs-gray-300">2024-11-14T09:23:41Z</span>
                </div>
                <div className="grid grid-cols-[140px_1fr] gap-2">
                  <span className="text-cs-gray-600">Operator:</span>
              ...
              {/* Inputs */}
              <div>
                <div className="text-cs-gray-600 mb-2">{'// ── INPUTS ──────────────────────────────────────────────────────────'}</div>
                <div className="space-y-1">
                  {[
                    ...
                    <div key={k} className="grid grid-cols-[140px_1fr] gap-2">
                      <span className="text-cs-gray-600">{k}:</span>
                      <span>
                        <span className={c}>{v}</span>
                        <span className="text-cs-gray-600 ml-2">{note}</span>
                      </span>
                    </div>
                  ))}
                </div>
              ...
              {/* Measurement */}
              <div>
                <div className="text-cs-gray-600 mb-2">{'// ── MEASUREMENT ────────────────────────────────────────────────────'}</div>
                <div className="space-y-1">
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">CI:</span>
                    <span className="text-red-400 font-bold">0.23 · INCOHERENT</span>
                  </div>
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Load class:</span>
                    <span className="text-red-400">OVERLOADED</span>
                  </div>
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Risk level:</span>
                    <span className="text-red-400">HIGH</span>
                  </div>
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Confidence:</span>
              ...
              {/* Decision */}
              <div>
                <div className="text-cs-gray-600 mb-2">{'// ── DECISION ────────────────────────────────────────────────────────'}</div>
                <div className="space-y-1">
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Action:</span>
                    <span className="text-cs-yellow">DEFER</span>
                  </div>
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Triggered:</span>
                    <span className="text-cs-gray-300">Volt — prompt delay: 22 minutes</span>
                  </div>
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Logged to:</span>
              ...
              {/* Artifact */}
              <div>
                <div className="text-cs-gray-600 mb-2">{'// ── ARTIFACT ────────────────────────────────────────────────────────'}</div>
                <div className="space-y-1">
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Provenance:</span>
                    <span className="text-cs-gray-300">sha256:a3f9d2c8b1e7f4a6d9c2e8b5f1a7d3c9</span>
                  </div>
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Receipt:</span>
                    <span className="text-cs-orange">/traces/CLOS-2024-0891.json</span>
                  </div>
                  <div className="grid grid-cols-[140px_1fr] gap-2">
                    <span className="text-cs-gray-600">Status:</span>
