      ...
      <div className="max-w-7xl mx-auto">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <a 
              href="https://github.com/chriscelaya" 
          ...
          <div className="mt-16 flex flex-wrap gap-8 text-sm">
            <div>
              ...
              <div className="text-xs font-mono uppercase text-zinc-600">Years Industrial Tech</div>
            </div>
            <div>
              <div className="text-2xl font-bold mb-1">172K+</div>
              <div className="text-xs font-mono uppercase text-zinc-600">Words Voice Journaled</div>
            </div>
            <div>
              <div className="text-2xl font-bold mb-1">90 Days</div>
              <div className="text-xs font-mono uppercase text-zinc-600">Current Experiment</div>
            </div>
            <div>
              <div className="text-2xl font-bold mb-1">100%</div>
              <div className="text-xs font-mono uppercase text-zinc-600">Self-Funded Research</div>
            </div>
          </div>
        </div>
      </div>
